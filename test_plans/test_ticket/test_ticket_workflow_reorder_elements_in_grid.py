...
def test_ticket_custom_fields_reorder_in_grid(page, login):
        ...
        drag_handle_1 = page.locator(f'//*[text()="{custom_field_field_name_1}"]//parent::tr/td[7]/span')
        drag_handle_2 = page.locator(f'//*[text()="{custom_field_field_name_2}"]//parent::tr/td[7]/span')
